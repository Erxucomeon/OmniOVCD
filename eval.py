...
from mmengine.utils import ProgressBar as MMProgressBar
import sys

class RealTimeProgressBar(MMProgressBar):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        if hasattr(self, '_prog_bar'):
            self._prog_bar.miniters = 1
            self._prog_bar.mininterval = 0
    
    def update(self, num_tasks=1):
        super().update(num_tasks)
        sys.stdout.flush()

import mmengine.utils
mmengine.utils.ProgressBar = RealTimeProgressBar
